...
class RouteTrip:
    ...
    def get_users_renfe(self, timeseries_o,max_precision = True):
        ...
        up = self.compute_users_method1(renfe_stops,subtimeseries_o,Td,'cercanias')
        if max_precision:
            up2 = self.compute_users_method2(renfe_stops,subtimeseries_o,self.ptdata.renfe_users_bystop,Td,'cercanias')
            up = (up + up2)/2
    ...
    def get_users_metro(self,timeseries_o, max_precision = True):
        ...
        up = self.compute_users_method1(metro_stops, subtimeseries_o, Td,'metro')
        if max_precision:
            up2 = self.compute_users_method2(metro_stops, subtimeseries_o,
